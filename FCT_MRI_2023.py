...
def run():
    ...
    health = hmerged[["Unnamed: 0", "fat_x", "himage_onset", "h_rt", "recorded_health_rating", "available_x", "food"]].copy()
    health.columns = ["t", "fat", "trialonset", "rt", "resp", "available", "food"]
    health["t"] = health["t"] + 1
    
    taste = tmerged[["Unnamed: 0", "fat_x", "timage_onset", "t_rt", "recorded_taste_rating", "available_x", "food"]].copy()
